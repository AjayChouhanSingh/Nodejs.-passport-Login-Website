 ...
 * Build: http://modernizr.com/download/#-backgroundsize-borderradius-boxshadow-opacity-rgba-cssanimations-generatedcontent-csstransitions-input-inputtypes-inlinesvg-touch-shiv-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes-load
 */
(window.Modernizr = (function (a, b, c) {
  ...
  for (var J in s)
    A(s, J) &&
      ((x = J.toLowerCase()), (e[x] = s[J]()), v.push((e[x] ? "" : "no-") + x));
  return (
    e.input || I(),
